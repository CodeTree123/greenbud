            ...
            <form method="POST" action="{{ route('post_shop_rented') }}" enctype="multipart/form-data">
                ...
                <div class="row">
                    ...
                    <div class="col-4 mb-3 ">
                        ...
                        <input name="floor_size" type="number" class="form-control" id="area_Rent" placeholder="Enter Shop Area">
                    </div>
                    <div class="col-4 mb-3">
            ...
            <form method="POST" action="{{ route('post_shop_wanted') }}" enctype="multipart/form-data">
                ...
                <div class="row">
                    ...
                    <div class="col-4 mb-3 ">
                        ...
                        <input name="floor_size" type="number" class="form-control" id="area_Want" placeholder="Enter Shop Area">
                    </div>
                    <div class="col-4 mb-3">
