            ...
            <form method="POST" action="{{ route('post_parking_spot_rented') }}" enctype="multipart/form-data">
                ...
                <div class="row">
                    <div class="col-4 mb-3 ">
                        ...
                        <input name="title" type="text" class="form-control" id="room_name_Rent" placeholder="Enter name">
                    </div>
                    <div class=" col-4 mb-3">
            ...
            <form method="POST" action="{{ route('post_parking_spot_wanted') }}" enctype="multipart/form-data">
                ...
                <div class="row">
                    <div class="col-4 mb-3 ">
                        ...
                        <input name="title" type="text" class="form-control" id="room_name_Want" placeholder="Enter name">
                    </div>
                    <div class=" col-4 mb-3">
                    ...
                    <div class=" col-4 mb-3">
                        ...
                        <select id="floor_height_Want" class="form-select"name="floor_height">
                                <option selected="">Choose...</option>
                                <option value="13">13</option>
                                <option value="14">14</option>
                                <option value="17">17</option>
