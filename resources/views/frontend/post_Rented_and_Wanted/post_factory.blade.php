            ...
            <form method="POST" action="{{ route('post_factory_rented') }}" enctype="multipart/form-data">
                ...
                <div class="row">
                    ...
                    <div class="col-4 mb-3 ">
                        ...
                        <input name="floor_height" type="number" class="form-control" id="height_rented" placeholder="Enter Floor Hieght">
                    </div>
                    <div class="col-4 mb-3">
            ...
            <form method="POST" action="{{ route('post_factory_wanted') }}">
                ...
                <div class="col-4 mb-3 ">
                    ...
                    <div class="col-4 mb-3 ">
                        ...
                        <input name="floor_height" type="number" class="form-control" id="height_wanted" placeholder="Enter Floor Hieght">
                    </div>
                    <div class="col-4 mb-3">
