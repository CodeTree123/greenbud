            ...
            <form method="POST" action="{{ route('post_warehouse_rented') }}" enctype="multipart/form-data">
                ...
                <div class="row">
                    ...
                    <div class="col-4 mb-3 ">
                        ...
                        <input name="floor_size" type="text" class="form-control" id="floor_size_Rent" placeholder="Enter Floor Area">
                    </div>
            ...
            <form method="POST" action="{{ route('post_warehouse_wanted') }}">
                ...
                <div class="row">
                    ...
                    <div class="col-4 mb-3">
                        ...
                        <select id="type_Want" class="form-select" name="type">
                            <option selected="">Choose...</option>
                            <option value="grocery">grocery</option>
                            <option value="cosmetic">cosmetic</option>
                            <option value="medicine">medicine</option>
                    ...
                    <div class="col-4 mb-3">
                        ...
                        <select id="floor_Want" class="form-select" name="floor_level">
                            <option selected="">Choose...</option>
                            <option value="1">1</option>
                            <option value="2">2</option>
                            <option value="3">3</option>
                    ...
                    <div class="col-4 mb-3">
                        ...
                        <select id="building_Want" class="form-select" name="building_condition">
                            <option selected="">Choose...</option>
                            <option value="good">good</option>
                            <option value="moderate">moderate</option>
                            <option value="best">best</option>
                    ...
                    <div class="col-4 mb-3 ">
                        ...
                        <input name="floor_size" type="text" class="form-control" id="floor_size_Want" placeholder="Enter Floor Area">
                    </div>
