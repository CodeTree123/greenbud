            ...
            <form method="POST" action="{{ route('post_picnic_rented') }}" enctype="multipart/form-data">
                ...
                <div class="row">
                    <div class="col-4 mb-3 ">
                        ...
                        <input name="title" type="text" class="form-control" id="title_Rent" placeholder="Enter Picnic Spot Name">
                    </div>
                    <div class=" col-4 mb-3">
                    ...
                    <div class="col-4 mb-3 ">
                        ...
                        <input name="land_area" type="number" class="form-control" id="area_Rent" placeholder="Enter Land Area">
                    </div>
                    <div class="col-4 mb-3 ">
            ...
            <form method="POST" action="{{ route('post_picnic_wanted') }}" enctype="multipart/form-data">
                ...
                <div class="row">
                    <div class="col-4 mb-3 ">
                        ...
                        <input name="title" type="text" class="form-control" id="title_Want" placeholder="Enter Picnic Spot Name">
                    </div>
                    <div class=" col-4 mb-3">
                    ...
                    <div class="col-4 mb-3 ">
                        ...
                        <input name="land_area" type="number" class="form-control" id="area_Want" placeholder="Enter Land Area">
                    </div>
                    <div class="col-4 mb-3 ">
