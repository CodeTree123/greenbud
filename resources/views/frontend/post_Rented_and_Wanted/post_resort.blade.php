            ...
            <form method="POST" action="{{ route('post_restuarant_rented') }}" enctype="multipart/form-data">
                ...
                <div class="row">
                    <div class="col-4 mb-3 ">
                        ...
                        <input name="resort_name" type="text" class="form-control" id="resort_name_Rent" placeholder="Enter Hotel name">
                    </div>
                    <div class=" col-4 mb-3">
            ...
            <form method="POST" action="{{ route('post_restuarant_wanted') }}" enctype="multipart/form-data">
                ...
                <div class="row">
                    <div class="col-4 mb-3 ">
                        ...
                        <input name="resort_name" type="text" class="form-control" id="resort_name_Want" placeholder="Enter Hotel name">
                    </div>
                    <div class=" col-4 mb-3">
