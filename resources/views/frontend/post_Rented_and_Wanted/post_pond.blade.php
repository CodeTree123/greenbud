            ...
            <form method="POST" action="{{ route('post_pond_rented') }}" enctype="multipart/form-data">
                ...
                <div class="row">
                    <div class="col-4 mb-3 ">
                        ...
                        <input name="title" type="text" class="form-control" id="title_Rent" placeholder="Enter Post Title">
                    </div>
                    <div class=" col-4 mb-3">
                    ...
                    <div class="col-4 mb-3 ">
                        ...
                        <input name="pond_area" type="number" class="form-control" id="area_Rent" placeholder="Enter Ponds Size">
                    </div>
                    <div class="col-4 mb-3 ">
                        <label for="height_Rent" class="form-label me-2 fw-bold">Water Level</label>
                        <input name="water_level" type="number" class="form-control" id="height_Rent" placeholder="Enter Water Level">
                    </div>
                    <div class="col-4 mb-3">
                        <label for="road_Rent" class="form-label me-2 fw-bold">Road Width</label>
                        <input name="road_width" type="number" class="form-control" id="road_Rent" placeholder="Enter Road Width">
                    </div>
                    <div class="col-4 mb-3 ">
        ...
        <div class="col-12" id="Want" style="display: none;">
            <form method="POST" action="{{ route('post_pond_wanted') }}">
                ...
                <div class="col-4 mb-3 ">
                        ...
                        <input name="title" type="text" class="form-control" id="title_Want" placeholder="Enter Post Title">
                    </div>
                    <div class=" col-4 mb-3">
                    ...
                    <div class="col-4 mb-3 ">
                        ...
                        <input name="pond_area" type="number" class="form-control" id="area_Want" placeholder="Enter Price">
                    </div>
                    <div class="col-4 mb-3 ">
                        <label for="height_Want" class="form-label me-2 fw-bold">Water Level</label>
                        <input name="water_level" type="number" class="form-control" id="height_Want" placeholder="Enter Price">
                    </div>
                    <div class="col-4 mb-3">
                        <label for="road_Want" class="form-label me-2 fw-bold">Road Width</label>
                        <input name="road_width" type="number" class="form-control" id="road_Want" placeholder="Enter Road Width">
                    </div>
                    <div class="col-4 mb-3 ">
