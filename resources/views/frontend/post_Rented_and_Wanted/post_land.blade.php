            ...
            <form method="POST" action="{{ route('post_land_rented') }}" enctype="multipart/form-data">
                ...
                <div class="row">
                    ...
                    <div class="col-4 mb-3 ">
                        ...
                        <input name="land_area" type="number" class="form-control" id="area_Rent" placeholder="Enter area">
                    </div>
                    <div class="col-4 mb-3 ">
                        <label for="height_Rent" class="form-label me-2 fw-bold">Land Hieght</label>
                        <input name="land_height" type="number" class="form-control" id="height_Rent" placeholder="Enter Hieght">
                    </div>
                    <div class="col-4 mb-3">
            ...
            <form method="POST" action="{{ route('post_land_wanted') }}">
                ...
                <div class="row">
                    ...
                    <div class="col-4 mb-3 ">
                        ...
                        <input name="land_area" type="number" class="form-control" id="area_Want" placeholder="Enter area">
                    </div>
                    <div class="col-4 mb-3 ">
                        <label for="height_Want" class="form-label me-2 fw-bold">Land Height</label>
                        <input name="land_height" type="number" class="form-control" id="height_Want" placeholder="Enter Height">
                    </div>
                    <div class="col-4 mb-3">
