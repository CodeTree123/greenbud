        ...
        <div class="col-12" id="Rent" style="display: none;">
            <form method="POST" action="{{ route('post_rooftop_rented') }}" enctype="multipart/form-data">
                ...
                <div class="col-4 mb-3 ">
                        ...
                        <input name="title" type="text" class="form-control" id="resort_name_Rent" placeholder="Enter Rooftop name">
                    </div>
                    <div class=" col-4 mb-3">
                    ...
                    <div class="col-4 mb-3 ">
                        ...
                        <input name="floor_area" type="text" class="form-control" id="Area_Rent" placeholder="Enter Roof Area">
                    </div>
                    <div class="col-4 mb-3 ">
        ...
        <div class="col-12" id="Want" style="display: none;">
            <form method="POST" action="{{ route('post_rooftop_wanted') }}">
                ...
                <div class="col-4 mb-3 ">
                        ...
                        <input name="title" type="text" class="form-control" id="resort_name_Want" placeholder="Enter Rooftop name">
                    </div>
                    <div class=" col-4 mb-3">
                    ...
                    <div class="col-4 mb-3 ">
                        ...
                        <input name="floor_area" type="text" class="form-control" id="Area_Want" placeholder="Enter Roof Area">
                    </div>
                    <div class="col-4 mb-3 ">
