                                ...
                                <a href="{{route('profile')}}" class="img-a ">
                                    @if (auth()->user()->photo == null )
                                        @if(auth()->user()->gender == 'Male' )
                                            <img src="{{asset('/man-dummy.png') }}" class="rounded-circle mx-auto img-img" alt="" srcset="">
                                        @else
                                            <img src="{{asset('/dummy-female.jpg') }}" class="rounded-circle mx-auto img-img" alt="" srcset="">
                                        @endif
                                    @else
